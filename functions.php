...
include_once( CHILD_DIR . '/includes/helper-functions.php' );
...
//* Remove Shop menu, we add it back on page_catalog.php
remove_action( 'genesis_after_header', 'genesis_do_nav' );


//* Add Featured Image on top of pages and posts before Primary Nav 
add_action( 'genesis_after_header', 'featured_page_image', 9 );
...
genesis_register_sidebar( array(
	'id'          => 'featured-rooms',
	'name'        => __( 'Featured Rooms', 'beautiful' ),
	'description' => __( 'This is the featured rooms widget area.', 'beautiful' ),
) );
genesis_register_sidebar( array(
	'id'          => 'welcome-message',
...
genesis_register_sidebar( array(
	'id'          => 'testimonials',
	'name'        => __( 'Testimonials', 'beautiful' ),
	'description' => __( 'This is the Testimonials widget area.', 'beautiful' ),
) );
genesis_register_sidebar( array(
	'id'          => 'after-entry',
...
add_image_size( 'full-slider', 1400, 700, TRUE );
add_image_size( 'slider', 800, 486, FALSE );
add_image_size( 'catalog-archive', 250, 320, FALSE );
add_image_size( 'page-featured', 1400, 400, TRUE );
